...
Potential genes that have their promoter linked to CpGs signature
```{r}
...
write.csv(Potential_gene_for_signature, file = "New_candidate_gene_BPRNACan_signature.csv")
...
Promoter in BPmetCan connected to at least one CpGs BPmetCan contact
```{r}
